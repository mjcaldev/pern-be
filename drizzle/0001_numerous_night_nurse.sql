...
CREATE UNIQUE INDEX "classes_invite_code_key" ON "classes" USING btree ("invite_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "enrollments_student_id_class_id_key" ON "enrollments" USING btree ("student_id","class_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "account_provider_id_account_id_key" ON "account" USING btree ("provider_id","account_id");--> statement-breakpoint
